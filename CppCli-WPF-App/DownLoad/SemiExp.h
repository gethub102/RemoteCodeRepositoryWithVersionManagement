...
namespace Scanner
{
	...
	public:
		...
		~SemiExp() {};
	private:
		bool isEndOfSemiExp(int& forBrace,int& forSemiCount, std::string endStr, const std::vector<Token> __tokens);
		bool isEndOfSemiExp_for(int& forBrace, int& forSemiCount, std::string endStr, const std::vector<Token> __tokens);
		bool isEndOfSemiExp_sharp(int& forBrace, int& forSemiCount, std::string endStr, const std::vector<Token> __tokens);
		bool isEndOfSemiExp_ccomment(int& forBrace, int& forSemiCount, std::string endStr, const std::vector<Token> __tokens);
