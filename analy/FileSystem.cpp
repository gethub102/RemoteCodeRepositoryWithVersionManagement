...
* ====================
* ver 2.5 : 17 Apr 16
* - modified the File::isGood clear flush and close functions
* ver 2.4 : 17 Apr 16
* - added function getBuffer and putBuffer
* ver 2.3 : 17 Apr 16
* - added function Path::getBef(...) to get the file name without ext
* ver 2.2 : 23 Feb 13
...
//----< get file size >----------------------------------
int Path::get_file_size(std::string filename) // path to file
{
	FILE *p_file = NULL;
	if (0 != fopen_s(&p_file, filename.c_str(), "rb"))
	{
		perror("fopen_s");
		return 0;
	}
